...
import { closeInputForms, idSubCategoriesUpdate } from '../../../adminSlice';

export default class InputFormsForSubCategories  extends React.Component {
    constructor(props) {
        super(props);
        this.state={
            userInputId: '',
...
onSend() {
        ...
        dispatch(idSubCategoriesUpdate(item));  
}
// ENTER INPUT
...
onClose() {
   ...
   renderTable() {
    ...
    render() {
     ...
     if (this.props.adminState.openInputFormsForSubCategories) {
        return(
